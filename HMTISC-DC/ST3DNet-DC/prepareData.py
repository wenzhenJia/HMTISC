...
days_test = 28 # divide data into two subsets: Train & Test, of which the test set is the last 10 days
len_test = T * days_test
map_height, map_width = 30, 30  # grid size
original_filename = 'data.h5'
...
filename = os.path.join("data", 'DC_c%d_p%d_t%d_noext'%(len_closeness, len_period, len_trend))
...
pickle.dump(mmn, f,protocol = 4)
pickle.dump(external_dim, f,protocol = 4)
pickle.dump(timestamp_train, f,protocol = 4)
pickle.dump(timestamp_test, f,protocol = 4)
f.close()
